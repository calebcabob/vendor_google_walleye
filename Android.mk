...
#LOCAL_DEX_PREOPT := false
#LOCAL_PRIVILEGED_MODULE := true
#LOCAL_SRC_FILES := proprietary/ambientmusic/app/AmbientSensePrebuilt.apk
#include $(BUILD_PREBUILT)

#include $(CLEAR_VARS)
#LOCAL_MODULE := AmbientSensePrebuilt.xml
#LOCAL_MODULE_CLASS := ETC
#LOCAL_MODULE_PATH := $(TARGET_OUT_ETC)/permissions
#LOCAL_SRC_FILES := proprietary/ambientmusic/etc/permissions/AmbientSensePrebuilt.xml
#include $(BUILD_PREBUILT)
